...
import { Lock, MessageSquare,Mail,Eye,EyeOff , CircleUser, Loader2} from 'lucide-react';
      ...
      <div className='flex flex-col justify-center items-center p-6 sm:p-12'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='relative'>
            ...
            <input
              type='text'
              className='input input-bordered w-full z-0 pl-10'
          ...
          <div className='form-control'>
            ...
            <div className='relative'>
              ...
              <button
                type='button'
                className='absolute inset-y-0 right-0 pr-3 flex items-center text-base-content/60 hover:text-base-content cursor-pointer'
